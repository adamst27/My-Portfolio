    ...
    <>
      <main className="overflow-hidden relative h-screen bg-black">
        ...
        <div className="absolute bottom-8 right-8">
          <ul className="flex justify-center mt-5 space-x-5">
            <li>
              <a href="#" className="text-gray-500 hover:text-light">
                <svg
                  className="w-8 h-8"
                  fill="currentColor"
                  viewBox="0 0 24 24"
      ...
      <section className="relative overflow-hidden bg-black">
        <div className="call-to-action flex flex-col items-center justify-center h-screen px-8">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl lg:text-6xl text-white call-to-action-heading">
            Let&apos;s work together
          </h2>
          <Link
            href="/contact"
